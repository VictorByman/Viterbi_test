...
int  my_main()
{
	...
	for(int kk=0;kk<4;kk++)
	{
		...
		case 1 :
			...
			break;
		case 2 :
			input_message[0] =  0xaf9dcb2f;
			input_message[1] =  0x63165ea4;
			input_message[2] =  0x06364b73;
			input_message[3] =  0x546ee4d7;
			input_message[4] =  0xf2b954c5;
			input_message[5] =  0xd0e0aa6c;
			input_message[6] =  0x0d2f22a6;
			input_message[7] =  0x00001aa8;
			break;
		case 3 :
			input_message[0] =  0x761ec4c4;
			input_message[1] =  0x5fb7839f;
			input_message[2] =  0x06673e82;
			input_message[3] =  0x8738162e;
			input_message[4] =  0x077f5dab;
			input_message[5] =  0x42ab1c81;
			input_message[6] =  0x93790800;
			input_message[7] =  0x0000f1d9;
			break;
		default : break;
		}
...
// v27_update_vasm_m8
	 ...
	 v27m_chainback_fixed(&fec, dec, Nenc-6, 0);
	           ...
	           for(int n=0;n<15;n++)  vt.bits[n+15] = dec[n];
	              ...
	              switch(kk) {
	              case 1 : if(sum!=1652) error();
	                       break;
	              case 3 : if(sum!=2151) error();
	              	       break;
	              default : error();
	                          }
